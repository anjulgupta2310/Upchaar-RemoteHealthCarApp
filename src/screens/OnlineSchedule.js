...
import {len} from './OnlineAppointment'


export default class OnlineSchedule extends Component {
  state = {
    name:'',
    preTime:'',
    preDate:'',
  ...
  checkitem() {
    ...
    {
        // console.log(i);
        const myitems = db.ref(`Appointment/OnlineAppointment/${license_id}/${i}`);
  ...
  render() {
    return (
      ...
      <View style={styles.container}>
        <Text style={styles.head}>Online Schedule</Text>
